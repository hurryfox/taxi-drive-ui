...
import {ClientListAdminDashComponent} from './dash/admin/clients-list/client-list.component';
...
const MAINMENU_ROUTES: Routes = [
  ...
  { path: 'dash', component: DashComponent, children: [
       ...
       { path: 'admin', children: [
         { path: 'clients-list/clients-list', component: ClientListAdminDashComponent },
